...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IOembedApiSync : IApiAccessor
    {
        ...
        OembedOut IcosaApiOembedOembed(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0);
        ...
        ApiResponse<OembedOut> IcosaApiOembedOembedWithHttpInfo(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0);
    ...
    public interface IOembedApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<OembedOut> IcosaApiOembedOembedAsync(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<OembedOut>> IcosaApiOembedOembedWithHttpInfoAsync(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class OembedApi : IOembedApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>OembedOut</returns>
        public OembedOut IcosaApiOembedOembed(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of OembedOut</returns>
        public Org.OpenAPITools.Client.ApiResponse<OembedOut> IcosaApiOembedOembedWithHttpInfo(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "OembedApi.IcosaApiOembedOembed";
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of OembedOut</returns>
        public async System.Threading.Tasks.Task<OembedOut> IcosaApiOembedOembedAsync(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<OembedOut> localVarResponse = await IcosaApiOembedOembedWithHttpInfoAsync(url, format, maxwidth, maxheight, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<OembedOut>> IcosaApiOembedOembedWithHttpInfoAsync(string? url = default(string?), string? format = default(string?), int? maxwidth = default(int?), int? maxheight = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<OembedOut>("/v1/oembed", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
