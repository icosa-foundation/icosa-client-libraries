...
class TestAssetSchemaOut(unittest.TestCase):
    """AssetSchemaOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetSchemaOut:
        """Test AssetSchemaOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetSchemaOut`
        """
        model = AssetSchemaOut()
        if include_optional:
            return AssetSchemaOut(
                author_id = '',
                author_name = '',
                name = '',
                description = '',
