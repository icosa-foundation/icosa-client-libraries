...
class AssetSchemaOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authorId", "authorName", "name", "description", "createTime", "updateTime", "url", "assetId", "formats", "displayName", "visibility", "tags", "isCurated", "thumbnail", "triangleCount", "presentationParams", "license"]
