...
# Required: False
# isArray: false
@export var lodHint: int:
	set(value):
		__lodHint__was__set = true
		lodHint = value
var __lodHint__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__lodHint__was__set:
		bzz_dictionary["lodHint"] = self.lodHint
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("lodHint"):
		me.lodHint = from_dict["lodHint"]
	return me
