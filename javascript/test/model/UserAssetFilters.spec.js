...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NinjaApi.UserAssetFilters();
  });
  ...
  describe('UserAssetFilters', function() {
    it('should create an instance of UserAssetFilters', function() {
      // uncomment below and update the code to test UserAssetFilters
      //var instance = new NinjaApi.UserAssetFilters();
      //expect(instance).to.be.a(NinjaApi.UserAssetFilters);
    });
