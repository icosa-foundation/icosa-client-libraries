...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NinjaApi.AssetResource();
  });
  ...
  describe('AssetResource', function() {
    it('should create an instance of AssetResource', function() {
      // uncomment below and update the code to test AssetResource
      //var instance = new NinjaApi.AssetResource();
      //expect(instance).to.be.a(NinjaApi.AssetResource);
    });
