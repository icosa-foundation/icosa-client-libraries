...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NinjaApi.LoginToken();
  });
  ...
  describe('LoginToken', function() {
    it('should create an instance of LoginToken', function() {
      // uncomment below and update the code to test LoginToken
      //var instance = new NinjaApi.LoginToken();
      //expect(instance).to.be.a(NinjaApi.LoginToken);
    });
