...
class PagedAssetSchemaOut(BaseModel):
    """
    PagedAssetSchemaOut
    """ # noqa: E501
    assets: List[AssetSchemaOut]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assets": [AssetSchemaOut.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None,
