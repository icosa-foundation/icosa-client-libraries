...
namespace Org.OpenAPITools.Model
{
    ...
    /// AssetSchemaOut
    /// </summary>
    [DataContract(Name = "AssetSchemaOut")]
    public partial class AssetSchemaOut
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetSchemaOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetSchemaOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetSchemaOut" /> class.
        /// </summary>
        ...
        public AssetSchemaOut(string authorId = default(string), string authorName = default(string), string name = default(string), string description = default(string), DateTime createTime = default(DateTime), DateTime updateTime = default(DateTime), string url = default(string), string assetId = default(string), List<AssetFormat> formats = default(List<AssetFormat>), string displayName = default(string), string visibility = default(string), List<string> tags = default(List<string>), bool? isCurated = default(bool?), Thumbnail thumbnail = default(Thumbnail), int triangleCount = default(int), Object presentationParams = default(Object), string license = default(string))
        {
            // to ensure "authorName" is required (not null)
            if (authorName == null)
            {
                throw new ArgumentNullException("authorName is a required property for AssetSchemaOut and cannot be null");
            }
            this.AuthorName = authorName;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AssetSchemaOut and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for AssetSchemaOut and cannot be null");
            }
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for AssetSchemaOut and cannot be null");
            }
            this.Url = url;
            // to ensure "assetId" is required (not null)
            if (assetId == null)
            {
                throw new ArgumentNullException("assetId is a required property for AssetSchemaOut and cannot be null");
            }
            this.AssetId = assetId;
            // to ensure "formats" is required (not null)
            if (formats == null)
            {
                throw new ArgumentNullException("formats is a required property for AssetSchemaOut and cannot be null");
            }
            this.Formats = formats;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for AssetSchemaOut and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "visibility" is required (not null)
            if (visibility == null)
            {
                throw new ArgumentNullException("visibility is a required property for AssetSchemaOut and cannot be null");
            }
            this.Visibility = visibility;
            // to ensure "thumbnail" is required (not null)
            if (thumbnail == null)
            {
                throw new ArgumentNullException("thumbnail is a required property for AssetSchemaOut and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetSchemaOut {\n");
